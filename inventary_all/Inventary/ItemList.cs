...
namespace DungeonSlayer.Units.Players.Inventory
{
    static class ItemsList
    {
        ...
        static public Armor trollArmor = new Armor("Troll clothes", 2, 2, 2, 80, 6);
        static public Armor stealArmor = new Armor("Steal Armor", 6, 0, 0, 100, 7);
        static public Armor elvenArmor = new Armor("Elven Armor", 7, 0, 3, 110, 7);
        static public Armor dwarfsArmor = new Armor("Dwarfs Armor", 10, 3, 0, 120, 8);
        static public Armor orkArmor = new Armor("Ork Armor", 9, 4, 0, 170, 9);
        static public Armor hunterArmor = new Armor("Hunter Armor", 7, 1, 2, 180, 9);
        static public Armor robeBachelor = new Armor("Robe Bachelor", 2, 0, 0, 190, 9);
        static public Armor obsidianArmor = new Armor("Obsidian Armor", 11, 2, 0, 220, 10);
        static public Armor elementsArmor = new Armor("Elements Armor", 8, 2, 2, 250, 11);
        static public Armor robeMaster = new Armor("Robe Master", 4, 1, 1, 270, 14);
        static public Armor dvemerArmor = new Armor("Dvemer Armor", 14, 0, 0, 350, 15);
        static public Armor demonicArmor = new Armor("Demonic Armor", 16, 4, 2, 500, 20);
        static public Armor angelArmor = new Armor("Angel Armor", 18, 3, 3, 500, 20);
        static public Armor diabloArmor = new Armor("Diablo Armor", 20, 4, 4, 800, 25);
        static public Armor godArmor = new Armor("God Armor", 23, 3, 3, 800, 25);
        ...
        static public Helmet hoodStudent = new Helmet("Hood Student", 0, 0, 1, 50, 3);
        static public Helmet goblinHelmet = new Helmet("Goblin Helmet", 1, 1, 0, 45, 3);
        static public Helmet leatherHelmet = new Helmet("Leather Helmet", 1, 0, 0, 55, 4);
        static public Helmet trollHelmet = new Helmet("Troll Helmet", 1, 1, 1, 70, 6);
        static public Helmet stealHelmet = new Helmet("Steal Helmet", 4, 0, 0, 85, 7);
        static public Helmet elvenHelmet = new Helmet("Elven Helmet", 5, 0, 2, 90, 7);
        static public Helmet dwarfsHelmet = new Helmet("Dwarfs Helmet", 6, 2, 0, 100, 8);
        static public Helmet orkHelmet = new Helmet("Ork Helmet", 7, 2, 0, 130, 9);
        static public Helmet hunterHelmet = new Helmet("Hunter Helmet", 5, 0, 1, 140, 9);
        static public Helmet hoodBachelor = new Helmet("Hood Bachelor", 1, 0, 2, 150, 9);
        static public Helmet obsidianHelmet = new Helmet("Obsidian Helmet", 8, 1, 0, 160, 10);
        static public Helmet elementsHelmet = new Helmet("Elements Helmet", 6, 1, 1, 180, 11);
        static public Helmet hoodMaster = new Helmet("Hood Master", 2, 0, 0, 280, 14);
        static public Helmet dvemerHelmet = new Helmet("Dvemer Helmet", 12, 0, 0, 300, 15);
        static public Helmet demonicHelmet = new Helmet("Demonic Helmet", 14, 2, 1, 4500, 20);
        static public Helmet angelHelmet = new Helmet("Angel Helmet", 15, 2, 2, 4500, 20);
        static public Helmet diabloHelmet = new Helmet("Diablo Helmet", 17, 2, 2, 700, 25);
        static public Helmet godHelmet = new Helmet("God Helmet", 20, 2, 2, 700, 25);
